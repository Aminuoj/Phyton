...
if page == 'Introduction to dataset':
    ...
    df = pd.read_excel("C:\\Users\\HP\\OneDrive - Conestoga College\\Phyton\\Salary_Prediction_Classification.xlsx")
    # initial dataset
...
""", language='python')
    ...
    df = pd.read_csv("C:\\Users\\HP\\OneDrive - Conestoga College\\Phyton\\Cleaned_data.csv")          
